    // Function to sync total price to the top right
    function syncTotalPrice() {
    const totalPriceElement = document.getElementById('totalPrice');
    const totalPriceTopRightElement = document.getElementById('totalPriceTopRight');

    // Copy the text content from totalPrice to totalPriceTopRight
    totalPriceTopRightElement.textContent = totalPriceElement.textContent;
}
    ...
    syncTotalPrice();  // Sync the total price to the top right
}
}
    ...
    // Sync the total price to the top right
    syncTotalPrice();
